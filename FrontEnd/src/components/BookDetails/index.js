      ...
      <div className="book-details-container container p-2">
        <div className="book-details-card card center-text">
          <div className="book-details-image-container">
            <img
              className="w-100 book-details-image"
              src={imageurl}
              alt="book"
            />
          </div>
          <div className="book-details-info-container flex-grow-1">
            ...
            <p className="book-details-book-info">
              by <span className="span-author">{author}</span>
            </p>
            <p className="book-details-book-info book-details-description">
              {description}
            </p>
            <p className="book-details-book-info">{category}</p>
            <div className="d-flex  justify-content-between align-items-center mt-auto">
              <p className="book-details-book-info book-details-price m-0">
                Rs {price} /-
              </p>
